          ...
          children: [
            IconButton(
                onPressed: () {
                  ...
                  int nuevaCantidad =
                      shoppingController.entries[index].quantity + 1;
                  shoppingController.agregarProducto(index, nuevaCantidad);
            ...
            IconButton(
                onPressed: () {
                  ...
                  int nuevaCantidad =
                      shoppingController.entries[index].quantity - 1;
                  shoppingController.quitarProducto(index, nuevaCantidad);
                  shoppingController.entries.refresh();
                },
